...
public class CheckExportFunctionality {

	public static void main(String[] args) {
		CheckExportFunctionality exporter = new CheckExportFunctionality();
        exporter.export("kptestuser");
//        exporter.export("Product");
    ...
    public void export(String table) {
        ...
        String jdbcURL = "jdbc:sqlserver://192.168.1.252:1433;databaseName=exportsql";
        String username = "exportsql_user";
        String password = "Appcino#202306@";
        ...
        while (result.next()) {
            ...
            for (int i = 2; i <= numberOfColumns; i++) {
                ...
                if (valueObject instanceof Boolean)
                    ...
                    cell.setCellValue((Short) valueObject);
                    formatDateCell(workbook, cell);
